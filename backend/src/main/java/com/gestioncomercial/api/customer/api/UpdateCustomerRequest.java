...
import com.gestioncomercial.api.customer.application.UpdateCustomerCommand;
...
public record UpdateCustomerRequest(
    ...
    UpdateCustomerCommand toCommand() {
        return new UpdateCustomerCommand(documentType, documentNumber, name, email, phone, address);
    }
}
