...
import com.gestioncomercial.api.supplier.application.UpdateSupplierCommand;
...
public record UpdateSupplierRequest(
    ...
    UpdateSupplierCommand toCommand() {
        return new UpdateSupplierCommand(ruc, businessName, tradeName, email, phone, address);
    }
}
